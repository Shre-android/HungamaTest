...
class MovieDetailViewModel : ViewModel() {
    ...
    /*
    Function to load the details of the movie from API
     */
    fun loadData(id:Int){
    ...
    /*
    function to load the cast and crew from API call
     */
